...
public class BlogServiceImpl implements BlogService {
	...
	public String saveBlog(Blog blog) {
		...
		BlogTag blogTag = tagMapper.selectByPrimaryKey(blog.getBlogTagId());
		if (blogTag == null) {
			blog.setBlogTagId(0);
			blog.setBlogTagName("默认标签");
		} else {
			blog.setBlogTagName(blogTag.getTagName());
		}
...
//			}
			...
			BlogTagRelation blogTagRelation = new BlogTagRelation();
			blogTagRelation.setBlogId(blog.getBlogId());
			blogTagRelation.setTagId(blog.getBlogTagId());
			blogTagRelations.add(blogTagRelation);
	...
	public String updateBlog(Blog blog) {
		...
		BlogTag blogTag = tagMapper.selectByPrimaryKey(blog.getBlogTagId());
		if (blogTag == null) {
			blogForUpdate.setBlogTagId(0);
			blogForUpdate.setBlogTagName("默认标签");
		}
		BlogCategory blogCategory = categoryMapper.selectByPrimaryKey(blog.getBlogCategoryId());
		if (blogCategory == null) {
