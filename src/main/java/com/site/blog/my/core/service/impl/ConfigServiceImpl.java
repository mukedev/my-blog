...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "1169050279@qq.com";
    public static final String yourName = "木客";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "湘ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2020 木客";
